...
/**
 * Creates a navbar for Wander Nurse that allows easy control of the navbar items.
 *
 * @package    theme_wandernurse
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class wandernursenavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_wandernurse();
    }

    /**
     * Prepares the navigation nodes for use with Wander Nurse.
     */
    protected function prepare_nodes_for_wandernurse(): void {
        global $PAGE;
    ...
    /**
     * Get all the wandernurenavbaritem elements.
     *
     * @return wandernursenavbaritem[] Wander Nurse navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this Wander Nurse navbar
     */
    ...
    /**
     * Remove a wandernursenavbaritem from the Wander Nurse navbar.
     *
     * @param  string|int $itemkey An identifier for the wandernursenavbaritem
     * @param  int|null $itemtype An additional type identifier for the wandernursenavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the wandernursenavbaritem.
     */
